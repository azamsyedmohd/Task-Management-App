  ...
  <>
    <section>
      <article className="lg:text-4xl md:text-3xl sm:text-2xl text-xl font-bold italic font-serif  py-4 md:py-8 lg:py-10 text-slate-600">
        <h1 className="text-center text-black">Task Management Application</h1>
      </article>
      <article className=" sm:w-3/4 w-full p-5 sm:p-2 mx-auto">
        <form className="w-full bg-gray-200 md:p-6 p-3">
          ...
          <div className="flex justify-end">
            <button className="bg-black p-2 rounded-md text-gray-200 font-thin italic hover:scale-110 ">
              Add new task
            </button>
          </div>
        </form>
